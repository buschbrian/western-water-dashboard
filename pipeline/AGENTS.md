...
| `lakes.py` | Natural terminal lakes (ADR-112, ADR-118): a record with no full level, its validator and payload. Written by `refresh_lakes.py`, never by the reservoir orchestrator. |
