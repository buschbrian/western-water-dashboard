...
- Current: [ADR-010](ADR-010-colorado-and-great-basin-systems-only.md),
  ...
  [ADR-109](ADR-109-remove-scofields-rejected-dam-point.md)
...
- Current: [ADR-006](ADR-006-simplified-technical-english.md),
  ...
  [ADR-117](ADR-117-publish-terminal-lakes-from-their-own-roster-and-payload.md),
  [ADR-118](ADR-118-show-terminal-lakes-on-their-own-page.md),
  [ADR-114](ADR-114-publish-a-water-type-and-an-operating-character.md),
...
| [ADR-117](ADR-117-publish-terminal-lakes-from-their-own-roster-and-payload.md) | Publish terminal lakes from their own roster and payload | Accepted; implements ADR-112 and extends ADR-056 and ADR-098; Walker Lake is the first lake, generated and not yet shown |
| [ADR-118](ADR-118-show-terminal-lakes-on-their-own-page.md) | Show terminal lakes on their own page | Accepted; extends ADR-117 and ADR-045; reached from the methods and data pages, not the bar |
